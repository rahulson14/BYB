    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="bg-blue-50 py-20 px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-700 leading-relaxed text-justify">
            At Brick by Bricks, we believe that a home is more than just a structure—it's a lifelong dream.
            We specialize in constructing private residential buildings that blend strength, beauty, and comfort,
            creating the perfect space for families to thrive. With a commitment to using only the highest quality
            materials and delivering exceptional service, we set a new standard in the construction industry.
            Our mission is to craft aesthetically pleasing, structurally sound homes where families can create lasting memories.
            When you build with Brick by Bricks, you're not just building a house—you're building your future.
          </p>
        </motion.div>
      </section>
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-3xl font-semibold mb-6 text-blue-700">Our Story</h2>
          <p className="text-lg text-gray-700 leading-relaxed text-justify">
            Every home has a story. Ours began in 2024, when we saw too many families in Assam struggling through
            the process of building their dream homes. There was no order—just confusion. Materials were poor,
            engineers were missing, workers came and went as they pleased, and the final homes rarely matched the dreams
            people started with. Worst of all, no one stood beside the homeowners to guide them, protect their budget,
            or ensure their peace of mind. That’s when we knew something had to change. We started Brick by Bricks
            to give people more than just walls and roofs—we wanted to give them comfort, trust, and the joy of building
            without the pain. With honest supervision, quality construction, and clear communication, we are here to help
            families create homes that are beautiful, strong, and truly theirs—without the pressure.
          </p>
        </motion.div>
      </section>
      ...
      <section className="py-20 px-4 max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-700 text-lg leading-relaxed text-justify">
            ...
            of the families who live in them. Born from a desire to bring order to chaos, we guide homeowners with transparent
            communication, honest supervision, and unmatched craftsmanship. Our goal is not just to build structures—but to build
            lasting relationships and homes where families can thrive, dream, and feel truly at peace.
          </p>
        </motion.div>
      </section>
    </div>
